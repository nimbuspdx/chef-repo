...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "nimbuspdx-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/nimbuspdx"
  #   chef.validation_client_name = "nimbuspdx-validator"
  #   chef.validation_key_path = ".chef/nimbuspdx-validator.pem"
  # end
end
